...
Выражение 2 ** X не нужно перемещать за пределы циклов, так как оно должно быть вычислено для каждой итерации цикла, чтобы сравнить его со значением в списке.
